                ...
                <div className="relative font-medium md:h-screen flex items-center content-center">
                    <div className="mr-auto ml-auto w-full">
                        <div className="w-full max-w-md mr-auto ml-auto mt-4 mb-1 text-center">
                            <h1 className="text-gray-800 block text-3xl font-extrabold font-title dark:text-gray-100">Sign in</h1>
                        </div>
                        <div className="w-full max-w-md mr-auto ml-auto mt-4">
                            <div className="bg-white shadow-lg rounded-md px-8 py-8 mb-4 ml-auto mr-auto dark:bg-gray-900 dark:shadow-slate-800">
                                <div className=" mb-6  h-20">
                                    <label className="block text-gray-700 text-sm font-medium mb-2 dark:text-gray-100" > Login </label>
                                    <TextInput
                                ...
                                <div className="mb-6  h-20">
                                    <label className="block text-gray-700 text-sm font-medium mb-2 dark:text-gray-100"> Password </label>
                                    <PasswordInput
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        <div className="text-center sm:text-left">
                                            <label>
                                                ...
                                                <span className="text-sm font-medium text-gray-700 dark:text-gray-100">Remember me</span>
                                            </label>
                                        </div>
