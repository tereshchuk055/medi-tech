...
export default function ProfileCard({ patient }: ProfileCardProps) {
    return (
        <>
            <div className="bg-white rounded-lg shadow-md p-6 relative flex items-center dark:bg-neutral-900 ">
                <div>
                    <img
                        src={patient.link}
                        alt="Doctor"
                    ...
                    <div className="py-3 sm:order-none order-3">
                        ...
                        <div className="flex items-center my-1">
                            ...
                            <div className="ml-2 truncate dark:text-gray-300">{patient.email}</div>
                        </div>
                        <div className="flex items-center my-1">
                            <a className="w-6 text-gray-700 text-sky-500">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div className="ml-2 truncate dark:text-gray-300">{patient.phoneNumber}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:w-2/3 order-first sm:order-none sm:-mt-10 pt-5">
                    <div className="py-3 ">
                        ...
                        <p className="text-gray-700 mb-2 dark:text-gray-300">
                            <span className="font-semibold ">About:</span> {patient.about}
                        </p>
                    </div>
                    ...
                    <div className="py-3">
                        ...
                        <p className="text-gray-700 mb-2 dark:text-gray-300">
                            <span className="font-semibold ">Weight:</span> {patient.weight} cm
                        </p>
                        <p className="text-gray-700 mb-2 dark:text-gray-300">
