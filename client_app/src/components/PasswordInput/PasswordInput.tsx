    ...
    return (
        <div className="relative items-center">
            <input type={showPassword ? 'text' : 'password'}
                ...
                onChange={onChange}
                placeholder="***************"
                className="w-full shadow-sm appearance-none border border-gray-400 rounded w-full py-4 px-3 text-gray-700 text-sm leading-tight focus:outline-none focus:border-indigo-300 hover:bg-gray-200 focus:bg-gray-100 focus:ring-0 " />
